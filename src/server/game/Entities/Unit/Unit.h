...
{
    public:
        ProcEventInfo(Unit* actor, Unit* actionTarget, Unit* procTarget, ProcFlags typeMask,
        ...
        ProcFlags GetTypeMask() const { return _typeMask; }
...
class TC_GAME_API Unit : public WorldObject
{
    ...
    public:
        ...
        static void ProcSkillsAndAuras(Unit* actor, Unit* actionTarget, ProcFlags typeMaskActor, ProcFlags typeMaskActionTarget,
        ...
        void TriggerAurasProcOnEvent(Unit* actionTarget, ProcFlags typeMaskActor, ProcFlags typeMaskActionTarget,
                                     ProcFlagsSpellType spellTypeMask, ProcFlagsSpellPhase spellPhaseMask, ProcFlagsHit hitMask, Spell* spell,
                                     DamageInfo* damageInfo, HealInfo* healInfo);
        ...
        bool IsPlayingHoverAnim() const { return m_updateFlag.PlayerHoverAnim; }
